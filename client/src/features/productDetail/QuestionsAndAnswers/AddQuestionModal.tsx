...
import { api, useAddQuestionMutation } from '../../../api/api';
import { useAppSelector } from '../../../app/hooks';

export const AddQuestionModal: FC = ({ showAddQuestionModal, setShowAddQuestionModal }) => {
  ...
  const [
    addQuestion,
    { isLoading: isAddQuestionLoading, isSuccess: isAddQuestionSuccess },
  ...
  return (
    <>
      <label htmlFor='questionModal' className='btn btn-warning btn-outline'>
        Add a Question +
      </label>
